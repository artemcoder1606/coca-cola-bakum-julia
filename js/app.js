(() => {
    ...
    document.addEventListener("click", (e => {
        ...
        if (!target.closest(".actions-header__form") && target !== document.querySelector(".search-header__button")) document.querySelector(".actions-header__form").classList.remove("_show");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
